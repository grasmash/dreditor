...
export default class Table extends Element {
  ...
  constructor(id = null, wrapper = true) {
    ...
    this.addClass(wrapper ? 'dreditor-table-wrapper' : 'dreditor-table');
     ...
     * @type {Element}
     */
    this.header = Element.create('<thead class="dreditor-table-header"/>').appendTo(this.table);
     ...
     * @type {Element}
     */
    this.body = Element.create('<tbody class="dreditor-table-body"/>').appendTo(this.table);
     ...
     * @type {Element}
     */
    this.footer = Element.create('<tfoot class="dreditor-table-footer"/>').appendTo(this.table);
    ...
    if (this.id) {
      if (wrapper) {
        this.addClass(`dreditor-${this.id}-table-wrapper`);
      }
      this.table.addClass(`dreditor-${this.id}-table`);
      this.header.addClass(`dreditor-${this.id}-table-header`);
      this.body.addClass(`dreditor-${this.id}-table-body`);
      this.footer.addClass(`dreditor-${this.id}-table-footer`);
    }
  }
