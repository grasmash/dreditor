...
export default class File extends Renderable {
  ...
  render() {
    return this.doRender('file', () => {
      ...
      this.header = _.createElement('<div>').addClass('dreditor-file-header').appendTo(this.container);
      _.createElement('<div>').addClass('dreditor-file-info').appendTo(this.header)
   ...
   */
  renderFilename() {
    return _.createElement('<span>').addClass('dreditor-filename').text(this.filename);
  }
