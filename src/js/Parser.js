...
export default class Parser extends Renderable {
  ...
  render() {
    return this.doRender(null, () => {
      ...
      let patches = _.createElement('<div>').addClass('dreditor-patches').appendTo(this.rendered);
  ...
  renderPatchesMenu() {
    return this.doRender('patch.menu', () => {
      let menu = _.createElement('<ul>').addClass('dreditor-patch-menu').append('<li><strong>Patch</strong></li>');
